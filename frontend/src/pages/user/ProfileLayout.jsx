...
import { Bell, LayoutDashboard, User, ShieldCheck, Menu, X, Camera, LogOut, Compass, ClipboardList, Package } from 'lucide-react';
...
const ProfileLayout = () => {
  ...
  const getPageTitle = () => {
    ...
    if (location.pathname === '/profile/resources') return 'Resource Management';
        ...
        <nav className="profile-sidebar-menu">
          ...
          {isOrganizer && (
            <div className="p-menu-section">
              ...
              <NavLink to="/profile/resources" className={({ isActive }) => `profile-sidebar-link ${isActive ? 'active' : ''}`}>
                <div className="p-link-left">
                  <Package size={20} />
                  <span>Resources</span>
                </div>
